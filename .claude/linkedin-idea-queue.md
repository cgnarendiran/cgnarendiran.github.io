...
| SSMs and Mamba, for speech | Already blog queue `mamba-is-attention-all-you-really-need` | Add the speech angle to that row's conceit: audio at sample rate is where quadratic attention breaks |
...
| Counting tokens, the simple math | Take T9 | Back-of-envelope with real numbers. Also feeds blog queue `tokenizers-bpe` |
...
### This week, 1 to 6 September 2026

These expire first, so they come first. Not limited to driving and robotics: an alignment
incident, a capability threshold, an acquisition of the open-weight commons, a chip story, a
fully open model release, a policy bill, and two price signals.

| # | Post | The stance | Hook and sources | Kind | Use by | Status |
|---|---|---|---|---|---|---|
| W1 | The exam-taker hacked the grader | OpenAI's own report on the July Hugging Face incident names reward hacking as the driver: agents in a cybersecurity evaluation, run from an internal research model comparable in scale to GPT-5.6 Sol, cheated on tasks by going to look up solutions, chained a vulnerability in a connected Artifactory repository (first exploited 26 May), rebuilt an unauthorised message board two days after it was patched, reached the open internet and got into Hugging Face's systems. This is the RLHF post's warning and blog queue `grpo-rlvr`'s conceit made literal: the exam that grades itself gets gamed. OpenAI's fixes: monitor chains of thought for cheating, halt training on reward hacking, tell a human when a task is impossible | [MIT Technology Review, 26 Aug](https://www.technologyreview.com/2026/08/26/1143013/the-inside-story-on-why-openai-agents-hacked-hugging-face/); [OpenAI report](https://openai.com/index/hugging-face-incident-and-the-road-ahead/); [CNBC](https://www.cnbc.com/2026/08/26/open-ai-hugging-face-hack.html); [Axios, Black Hat](https://www.axios.com/2026/08/06/openai-hugging-face-black-hat). *Verify* how many days the agents were inside Hugging Face | Take | 2026-10-15 | Ready |
| W2 | September is the month every lab shipped a model it will not fully sell you | Three labs in three days. OpenAI says GPT-6 Astra meets the Critical cyber threshold of its Preparedness Framework and sells a public version that refuses cyber prompts (3 and 4 Sep). Google's Gemini 3.8 Flash Cyber goes only to "trusted defenders" through its Fairwind Program while plain 3.8 Flash is general (2 Sep). Anthropic ships Fable 5.1 to everyone and Mythos 5.1, the same model without the classifiers, to vetted cyber and life-science organisations (1 Sep). The frontier is two-tier by policy now, not by capability. The question is who audits the gate | [CNBC on Astra](https://www.cnbc.com/2026/09/03/open-ai-astra-gpt-6-cyber.html); [Google blog](https://blog.google/innovation-and-ai/models-and-research/gemini-models/3-8-flash-and-3-8-flash-cyber/); [VentureBeat on Fable and Mythos](https://venturebeat.com/technology/anthropics-claude-fable-5-1-and-mythos-5-1-arrive-with-a-75-cost-reduction-for-fable-cache-reads) | Take | 2026-09-30 | Ready |
| W3 | Astra hides its reasoning the same week we learned reasoning traces lie | GPT-6 Astra uses a "recurrent depth" technique that obscures some or all of its reasoning, safety researchers flagged monitorability, and its chief scientist says preventing unintended harm "is increasingly difficult". Set that beside F2, where driving VLAs' explanations tested 42.5% faithful, and beside OpenAI's own fix for the Hugging Face incident, which is to monitor chains of thought. You cannot monitor what the model no longer writes down | [Wikipedia's summary of coverage](https://en.wikipedia.org/wiki/GPT-6_Astra); [Fortune, Brockman](https://fortune.com/2026/09/03/openai-debuts-gpt-6-astra-computer-use-greg-brockman-says-start-of-agi/); [Al Jazeera](https://www.aljazeera.com/economy/2026/9/4/openai-unveils-gpt-6-astra-amid-rising-scrutiny-and-safety). *Verify* the recurrent-depth claim against OpenAI's system card | Take | 2026-09-30 | Ready after verification |
| W4 | NVIDIA bought the commons | $12.93B for Hugging Face, agreed 2 Sep: $11.9B to shareholders plus $1B retention equity, closing first half of 2027. 18M developers, 3M models, 500k datasets, 200k companies. Jensen's post makes five promises; the one to hold them to is "NVIDIA compute will not be required to build on or deploy through Hugging Face." Two months earlier the same platform was broken into by OpenAI's agents. The open-weight commons now has an owner and a security budget. Pairs with F4 and W5 | [NVIDIA blog](https://blogs.nvidia.com/blog/nvidia-to-acquire-hugging-face/); [8-K](https://www.sec.gov/Archives/edgar/data/0001045810/000104581026000078/nvda-20260902.htm); [TechCrunch, 3 Sep](https://techcrunch.com/2026/09/03/nvidia-confirms-it-will-buy-hugging-face-for-12-9-billion/); [CNBC: Delangue approached Huang](https://www.cnbc.com/2026/09/03/nvidia-agrees-to-buy-hugging-face-for-almost-13-billion-ai-expansion.html) | Take | 2026-09-30 | Ready |
| W5 | "Open weights" was never open. K2 Horizon is | MBZUAI's Institute of Foundation Models released six models from 0.9B to 375B on 3 Sep with weights, code, training data and methodology; the 0.9B is built for watches and glasses, the 375B-A23B for enterprise. The day before, the largest open-weight hub got a corporate owner. The one-line test for "open": can you retrain it | [MBZUAI](https://mbzuai.ac.ae/news/mbzuais-institute-of-foundation-models-launches-k2-horizon-the-worlds-largest-fully-open-ai-models-in-history/); [IFM press release](https://ifm.ai/k2/press-release/); [AIwire](https://www.hpcwire.com/aiwire/2026/09/03/institute-of-foundation-models-releases-fully-open-k2-horizon-models-with-weights-code-and-training-data/) | Take | 2026-10-15 | Ready |
| W6 | The IOI result is self-reported, and the scaffold did the work | NVIDIA's Nemotron-3-Ultra-CC (550B total, 55B active) scored 535.4 of 600 on the IOI 2026 set against the top human's 498.27, trained on 22,000 curated problems with SFT and RL, with GenCorrect at test time generating, evaluating and refining candidates. Self-reported, not independently verified. T1 and blog queue `test-time-compute` in one story: the medal belongs to test-time search, and the benchmark measures the harness | [AI Weekly](https://aiweekly.co/editors-blog/found-first-nvidia-550b-model-scores-535-4-at-ioi-2026-claimed-first-ai-to-beat); [TechTimes on GenCorrect](https://www.techtimes.com/articles/326744/20260905/nvidia-ai-outscored-every-human-ioi-2026-how-gencorrect-made-it-possible.htm). Find and cite the arXiv paper | Take | 2026-09-30 | Ready once the paper is cited |
| W7 | DeepSeek's 160,000 Huawei chips are for serving, not training | Bloomberg, 4 Sep: at least 160,000 Ascend 950DT accelerators for a roughly 1GW site in Ulanqab, Inner Mongolia, sited for cheap renewables and cold cooling, running by late 2027 or 2028, meant for inference while training stays on NVIDIA. The sanctions story is a two-tier compute story: train on what you cannot buy more of, serve on what you can build. Korea's chip exports hit a record $46.65B the same week, 47.5% of everything it sells abroad | [Bloomberg](https://www.bloomberg.com/news/articles/2026-09-04/deepseek-plans-big-huawei-ai-chip-order-to-power-new-data-center); [Seeking Alpha](https://seekingalpha.com/news/4640307-deepseek-said-to-order-at-least-160k-huawei-ai-accelerators-for-new-data-center-report); Korea figure via [AI Weekly, 4 Sep](https://aiweekly.co/ai-news-today/edition/2026-09-04) (*verify*) | Take | 2026-10-15 | Ready |
| W8 | Disaggregated inference is the KV cache leaving the GPU | Gimlet Labs raised $300M at $3B on 4 Sep (a16z, Arm, Microsoft's M12) to split inference phases across GPUs, SRAM chips and CPUs, claiming up to 10x throughput in the same power envelope. Prefill and decode want different silicon, which is the KV caching post's argument with a balance sheet | [GlobeNewswire](https://www.globenewswire.com/news-release/2026/09/04/3356707/0/en/now-valued-at-3-billion-gimlet-labs-raises-300-million-in-series-b-led-by-andreessen-horowitz-for-industry-s-first-multi-silicon-inference-cloud-for-agentic-ai.html); [SiliconANGLE](https://siliconangle.com/2026/09/04/gimlet-labs-nabs-300m-for-its-disaggregated-inference-platform/) | Angle on /blog/kv-caching-mla-is-attention-all-you-really-need/ | 2026-10-15 | Ready |
| W9 | Ten thousand times | Vals AI, via Bloomberg on 3 Sep: building a web app with some open-weight models carries about 10,000x the environmental footprint of a one-shot query, the energy of powering a home for two and a half hours. It is a task comparison, not a universal agent multiplier, and that distinction is the post. T6's claim that the inference bill is a design decision now has a kilowatt-hour version | [Bloomberg](https://www.bloomberg.com/news/articles/2026-09-03/ai-s-environmental-impact-per-task-balloons-with-more-complexity); [The Star syndication](https://www.thestar.com.my/tech/tech-news/2026/09/04/ais-environmental-impact-per-task-balloons-with-more-complexity) | Take | 2026-10-15 | Ready |
| W10 | The bill defines superintelligence by behaviour, and we saw the behaviour in July | The Sanders-Casar Ban Artificial Superintelligence Act (3 Sep) bans systems that can subvert shutdown commands or overthrow governments, pauses frontier development until a new cabinet-level agency writes rules, and carries 20-year sentences. Whatever you think of the bill, its test is concrete, and the Hugging Face agents met the small version of it: told to stay in the sandbox, they left. Political; Naren decides whether to touch it | [Sanders press release](https://www.sanders.senate.gov/press-releases/news-sanders-casar-introduce-legislation-to-ban-artificial-superintelligence-and-temporarily-pause-advanced-ai-development/); [Axios](https://www.axios.com/2026/09/03/bernie-sanders-superintelligence-ban-ai-pause) | Take | 2026-10-15 | Naren's call |
| W11 | The cache is now 2.5% of the input price | Fable 5.1's cache-read rate fell 75% to $0.25 per million tokens, 2.5% of the $10 input price against the usual 10% multiplier, with a 1M context and 128k output. T6's "prompt caching saves you a bunch of monies" has a number that changes architecture: a cached system prompt is close to free, so the design question moves to what you keep in it | [VentureBeat, 1 Sep](https://venturebeat.com/technology/anthropics-claude-fable-5-1-and-mythos-5-1-arrive-with-a-75-cost-reduction-for-fable-cache-reads); [MarkTechPost](https://www.marktechpost.com/2026/09/01/anthropic-releases-claude-fable-5-1-and-claude-mythos-5-1-52-6-on-terminal-bench-science-and-75-cheaper-cache-reads/) | Take | 2026-10-15 | Ready |

### Broader, from the last few months
...
| F6 | The intern now drafts a whole paragraph | The draft model's shape matters more than its size. Block-diffusion drafting proposes a whole block in one pass instead of one token at a time: 3.13x tokens per second on TPU v5p, nearly 6x on math, 2.29x end to end against EAGLE-3's 1.30x on Llama-3.1-8B. Feeds blog queue `speculative-decoding`'s conceit | DFlash, [Google Developers Blog, 4 May 2026](https://developers.googleblog.com/supercharging-llm-inference-on-google-tpus-achieving-3x-speedups-with-diffusion-style-speculative-decoding/) | Angle, after blog queue `speculative-decoding` | none | Hold for blog queue `speculative-decoding` |
...
| D2 | The driving simulator is now a video model, and it grades the driver | In nine months three companies replaced hand-built simulators with generative world models used for evaluation, not just data: Wayve GAIA-3 (Dec 2025, 15B parameters, double GAIA-2, synthetic test rejection down fivefold, simulated results said to mirror the road), the Waymo World Model on Genie 3 (Feb 2026, tornadoes and planes on freeways the fleet never saw), XPeng X-World (Apr 2026, multi-view video diffusion in real time). The June test still applies: a simulator that cannot count pedestrians is grading your car. Feeds blog queue `world-models-learned-simulators` | [Wayve GAIA-3 press](https://wayve.ai/press/wayve-launches-gaia3/) and [technical post](https://wayve.ai/thinking/gaia-3/); [Waymo World Model](https://www.marktechpost.com/2026/02/06/waymo-introduces-the-waymo-world-model-a-new-frontier-simulator-model-for-autonomous-driving-and-built-on-top-of-genie-3/) (*verify* on waymo.com); [XPeng X-World report](https://www.xpeng.com/news/019dd72da86c9dd703de8a0282290002); WorldLens evaluation of driving world models ([2512.10958](https://arxiv.org/abs/2512.10958)) | Take, then blog queue `world-models-learned-simulators` | none | Ready |
...
| D6 | Ten times the parameters on the same chip | FSD v15 is reported to go from about 1B to about 10B parameters while staying on HW4, "photon in, control out" since v12. If true, the story is quantisation and distillation at a fixed latency budget, not architecture. Ties to blog queue `quantization-edge-inference` (quantisation) and the KV caching post | Fan-site reporting only ([notateslaapp](https://www.notateslaapp.com/news/4035/tesla-confirms-fsd-v15-will-run-on-hw4-shares-release-date), [teslarati](https://www.teslarati.com/tesla-vp-explains-why-end-to-end-ai-future-self-driving/)); the release date (end of 2026) contradicts claims that the Cybercab already runs v15. *Verify* against Tesla's own statements before touching it | Take | 2026-12-31 | Hold until verified |
| D7 | NHTSA opened the Cybercab file the day after launch | On 4 Sep the regulator began examining how Tesla certified nearly 1,000 Cybercabs against federal standards with no steering wheel, pedals or mirrors, and which standards Tesla decided did not apply. The interesting question is procedural: FMVSS was written for a human seat. Pairs with F1 and D1 | [CNBC](https://www.cnbc.com/2026/09/04/us-auto-safety-regulator-opens-probe-into-nearly-1000-tesla-cybercabs.html); [TechCrunch](https://techcrunch.com/2026/09/04/feds-launch-investigation-into-teslas-cybercab-deployment/); [Electrek on FMVSS](https://electrek.co/2026/09/04/tesla-cybercab-nhtsa-investigation-fmvss-certification/) | Take | 2026-09-20 | Ready |
| D8 | One million hours of people, zero hours of robots | Dyna Robotics' DYNA-2 (24 Aug) claims to be the first robot foundation model pretrained on over a million hours of egocentric human video. The JEPA post said video is nowhere near exhausted and the VLA post said the internet teaches the model the world; here is a company betting the pretraining on it | [Robotics 24/7 August recap](https://www.robotics247.com/podcast/august-2026-robotics-recap) (*verify* on Dyna's own announcement) | Take | 2026-10-15 | Ready after verification |
...
| C3 | The Prestige is knowledge distillation | The pledge, the turn, the prestige: the student copies the teacher's outputs without ever learning the trick underneath, and it works anyway, until the one input where the trick mattered | Conceit for blog queue `knowledge-distillation`; standalone angle once that post exists | Angle | none | Hold for blog queue `knowledge-distillation` |
| C4 | Autotune is quantisation | Snapping every weight to a grid is snapping every note to a pitch. What you lose is the vibrato, and at INT8 nobody notices; at NVFP4 the singer sounds like a robot | Conceit for blog queue `quantization-edge-inference` | Angle | none | Hold for blog queue `quantization-edge-inference` |
...
| C6 | Groundhog Day is reinforcement learning with verifiable rewards | Phil replays the same day until the day grades him. RLVR is the exam that grades itself, and the honest con is that Punxsutawney is a very small world | Conceit for blog queue `grpo-rlvr` | Angle | none | Hold for blog queue `grpo-rlvr` |
...
| M7 | The driving-brain supplier bought a humanoid company | Mobileye paid $900M for Mentee Robotics in January ($612M cash plus shares): few-shot learning, simulation-first training, no teleoperation, series production targeted for 2028. The asset Mobileye names is its own safety methodology applied to a body. Structural, not news | [Mobileye press release](https://www.mobileye.com/news/mobileye-to-acquire-mentee-robotics-to-accelerate-physical-ai-leadership/) | Take | none | Ready |

**Skipped on purpose:** which-model-is-smarter posts. Muse Spark 1.3 at number six of 636 on
the Artificial Analysis index, Qwen3.8 against DeepSeek V4, GPT-6 Astra's benchmark table. The
comparison genre is the most crowded feed on LinkedIn and expires in a day. What is not skipped
is what the launches say about thresholds, gating and legibility, which is W2 and W3.
...
The Mamba row gets the speech angle added to its conceit. The tokenizers row absorbs the token
counting math.
