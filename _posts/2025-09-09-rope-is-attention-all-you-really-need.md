...
But these have gone through significant improvements over the years. These include the introduction of KV caching, multi-head attentions (MHA), rotary positional encodings (RoPE), and mixture of experts (MoE). In my [previous post](/blog/kv-caching-mla-is-attention-all-you-really-need/) I spoke about MLA and KV caching. In this post I'll talk about Rotary Positional Encodings (RoPE).
